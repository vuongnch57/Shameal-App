 ...
 */
package com.example.shameal.handler;
...
import com.example.shameal.DecodeThread;
  ...
  public void handleMessage(Message message) {
    ...
    switch (message.what) {
      ...
      case R.id.ocr_decode_failed:
        state = State.PREVIEW;
        activity.setShutterButtonClickable(true);
        Toast toast = Toast.makeText(activity.getBaseContext(), "Capture failed. Please try again.", Toast.LENGTH_SHORT);
