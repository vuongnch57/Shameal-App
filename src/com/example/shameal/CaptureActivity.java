...
import com.example.shameal.camera.CameraManager;
import com.example.shameal.camera.ShutterButton;
import com.example.shameal.handler.DecodeHandler;
import com.googlecode.tesseract.android.TessBaseAPI;
import com.example.shameal.handler.CaptureActivityHandler;
import com.example.shameal.handler.DecodeHandler;
...
import com.example.shameal.ocr.OcrCharacterHelper;
import com.example.shameal.ocr.OcrInitAsyncTask;
import com.example.shameal.ocr.OcrResult;
import com.example.shameal.ocr.OcrResultFailure;
import com.example.shameal.ocr.OcrResultText;
 ...
 * 
 * The code for this class was adapted from the ZXing project: shttp://code.google.com/p/zxing/
 */
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  void onShutterButtonPressContinuous() {
    ...
    if (lastResult != null) {
      ...
      /*Toast toast = Toast.makeText(this, "Capture failed. Please try again.", Toast.LENGTH_LONG);
